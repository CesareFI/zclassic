 ...
 *
 * Tests for the binary A/B fallback module (engine/services/src/binary_ab_fallback.c)
 ...
 * see SLOT_WIN32_REFUSAL in platform/modules/platform/src/os_binary_slots.c: there is no
