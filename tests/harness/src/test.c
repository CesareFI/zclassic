 ...
 * tests/harness/src/test_make_lint_gates.c). test_make_lint_gates() alone is now
...
int main(int argc, char **argv)
{
    ...
    { extern int test_stale_offers_only(void);
      failures += test_stale_offers_only(); }
    ...
    { extern int test_peer_dos_fairness(void);
      failures += test_peer_dos_fairness(); }
    ...
    { extern int test_zcode_dht_frame_auth(void);
      failures += test_zcode_dht_frame_auth(); }
    ...
    { extern int test_fastobj_carrier(void);
      failures += test_fastobj_carrier(); }
    ...
    { extern int test_story_graph(void); failures += test_story_graph(); }
    ...
    { extern int test_code_semantic_candidate(void);
