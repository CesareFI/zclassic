...
platform/modules/util/tests/thread_registry_android_acceptance.c	Android cooperative-lifecycle acceptance, not a Windows program: make test-android-thread-registry-acceptance compiles the production registry with __ANDROID__ and executes timeout/retry/final-reap behavior on the host. Cross-platform registry behavior remains covered by the registered thread_registry group.
