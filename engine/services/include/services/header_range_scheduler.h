...
/* Return target - local_height without signed overflow. An extreme untrusted
 * peer height is only a scheduling hint; saturate it at the largest useful
 * positive gap rather than allowing it to suppress range scheduling. */
